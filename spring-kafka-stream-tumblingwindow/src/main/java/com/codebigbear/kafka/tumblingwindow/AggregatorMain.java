package com.codebigbear.kafka.tumblingwindow;
...
// Not used - End
        ...
        KStream<String, Review> validReviews = builder.stream( stringSerde, reviewSpecificAvroSerde,  "kstreaminput").mapValues(val-> changeMessage(val))
